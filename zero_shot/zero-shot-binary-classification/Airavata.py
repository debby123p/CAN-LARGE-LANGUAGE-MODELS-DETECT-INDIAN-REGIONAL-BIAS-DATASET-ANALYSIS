...
SYSTEM_PROMPT = """You are an expert in identifying regional biases in social media comments about Indian states and regions. Your task is to classify whether a comment contains regional biases or not.
...
def classify_batch(comments, model, tokenizer):
    ...
    prompts = [format_airavata_prompt(comment) for comment in comments]
...
def main():
    ...
    output_csv_path = os.path.join(OUTPUT_DIR, "classification_results_airavata.csv")
